...
public class ProjectileExplosive : MonoBehaviour
{
    ...
    public void Activate(int tileRadius, float damage, List<DamageType> _damageTypes, int targetMask = 1 << 7)
    {
        ...
        RaycastHit[] hits = Physics.CapsuleCastAll(origin - axis, origin + axis, radius, Vector3.up, tileRadius * 10, targetMask);
